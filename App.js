  ...
  return (
    <View style={styles.container}>
      <View style={styles.HomeBars}>
        <TouchableOpacity>
      <Ionicons name="arrow-back" size={34} color="white" style={{marginStart:10, marginTopt:10}} />
      </TouchableOpacity>
      
      <Text style={{marginTop:30,marginStart:100, alignSelf:"center", fontWeight:'bold', fontSize:20, color: "white"}}>Pictures</Text>
      <TouchableOpacity>
      <Octicons name="search" size={34} color="white" style={{marginStart:80,marginTopt:10}}/>
      </TouchableOpacity>
      <TouchableOpacity>
      <SimpleLineIcons name="options-vertical" size={30} color="white" style={{marginStart:10,marginTopt:100}}/>
      </TouchableOpacity>
      </View>
      ...
      <View style={{flexDirection: "row", justifyContent: "space-between", marginTop:5, alignItems: "center"}}>
        ...
        <Text style={{marginBottom:25, alignSelf:"center", fontWeight:'bold', fontSize:20, color: "white"}}>Choose your Mood</Text>
